        ...
        <div className="Calendar">
            ...
            <tbody>
                <tr>
                    ...
                    <td></td>
                    <Event event='Offense Training' color='yellow' location='Home Field'></Event>
                    <Event color='blue'></Event>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <Event event='B' color='blue'></Event>
                    <Event event='Team Tactics' color='purple' location='Study Room'></Event>
                    <td></td>
                ...
                <tr>
                    ...
                    <Event color='blue'></Event>
                    <Event event='Defense Training' color='green' location='Home Field'></Event>
                    <Event color='yellow'></Event>
                    <Event color='blue'></Event>
                ...
                <tr>
                    ...
                    <Event event='R' color='blue'></Event>
                    <Event color='purple'></Event>
                    <Event event='General Warm-Up' color='red' location='Home Field'></Event>
                ...
                <tr>
                    ...
                    <Event event='Tape Review' color='pink' location='Theatre'></Event>
                    <Event event='Tape Review' color='pink' location='Theatre'></Event>
                    <Event event='A' color='blue'></Event>
                    <Event event='Tape Review' color='pink' location='Theatre'></Event>
                    <Event event='Tape Review' color='pink' location='Theatre'></Event>
